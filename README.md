[![Build](https://github.com/Dometrain/from-zero-to-hero-parallel-programming-in-csharp/actions/workflows/build.yml/badge.svg)](https://github.com/Dometrain/from-zero-to-hero-parallel-programming-in-csharp/actions/workflows/build.yml)
